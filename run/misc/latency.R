...
tx_95th <- c(
	...
	NA, NA)
tx_99th <- c(
	sprintf("%.3fs", quantile(newOrder$latency, probs=0.99) / 1000.0),
	sprintf("%.3fs", quantile(payment$latency, probs=0.99) / 1000.0),
	sprintf("%.3fs", quantile(orderStatus$latency, probs=0.99) / 1000.0),
	sprintf("%.3fs", quantile(stockLevel$latency, probs=0.99) / 1000.0),
	sprintf("%.3fs", quantile(delivery$latency, probs=0.99) / 1000.0),
	sprintf("%.3fs", quantile(deliveryBG$latency, probs=0.99) / 1000.0),
	NA, NA)
tx_avg <- c(
